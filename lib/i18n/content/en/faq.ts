...
/**
 * FAQ content, shared between the home page (the `featured` subset) and the
 * dedicated /faq page (everything, grouped by topic).
 *
 * Ids are locale-independent: they key the per-page selections on
 * /rental-car, /return-car and /for-drivers, and they anchor the topic links.
 * Never translate an id.
 */
